...
const (
	WithdrawService_DoWithdraw_FullMethodName = "/commands.withdraw.WithdrawService/DoWithdraw"
)
...
type WithdrawServiceClient interface {
	DoWithdraw(ctx context.Context, in *DoWithdrawParams, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *withdrawServiceClient) DoWithdraw(ctx context.Context, in *DoWithdrawParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type WithdrawServiceServer interface {
	DoWithdraw(context.Context, *DoWithdrawParams) (*emptypb.Empty, error)
...
func (UnimplementedWithdrawServiceServer) DoWithdraw(context.Context, *DoWithdrawParams) (*emptypb.Empty, error) {
...
func _WithdrawService_DoWithdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WithdrawServiceServer).DoWithdraw(ctx, req.(*DoWithdrawParams))
	}
...
var WithdrawService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "commands.withdraw.WithdrawService",
	...
	Metadata: "proto/commands/withdraw/withdraw_service.proto",
}
